...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Usage Example:
        python start_virtualization.py --num_leds 327 --width 1650 --height 950 --port COM4 --baud_rate 921600
                -or-
        python start_virtualization.py -p COM4
''',
    ...
    parser.add_argument("-p", "--port", type=str, default="COM4", help="The USB serial port that the ESP32 is connected to. Defaults to COM4")
